...
import { fmtUSD, PNL_30D, BOTS, TRADES, computeStats } from '../data/mockData';
    ...
    <div className="page-enter">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <StatCard
          ...
          accent="#00D4FF"
          icon={Wallet}
          sparkData={PNL_30D.map((d) => ({ value: d.value }))}
        />
        <StatCard
          label="Today's P&L"
          value={fmtUSD(stats.today, { sign: true })}
          delta={(stats.today / stats.total) * 100}
          deltaLabel="of portfolio"
          accent={stats.today >= 0 ? '#00FF88' : '#FF5A6E'}
      ...
      {/* ============================================================
          PORTFOLIO P&L — Area chart with gradient fill and range selector
          ============================================================ */}
      <div className="glass p-6 mb-6">
        ...
        <div style={{ width: '100%', height: 280 }}>
          <ResponsiveContainer>
            <AreaChart data={PNL_30D} margin={{ top: 10, right: 12, left: -12, bottom: 0 }}>
              <defs>
      ...
      <div className="grid lg:grid-cols-3 gap-5 mb-6">
        <div className="lg:col-span-1">
          ...
          <div className="flex flex-col gap-3">
            {activeBots.map((b) => (
              <BotCard key={b.id} bot={b} compact />
            ))}
          </div>
        </div>
        <div className="lg:col-span-2">
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-[12px] text-blue hover:underline">
              View all →
            </button>
          </div>
